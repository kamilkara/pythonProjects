...
def askForType():
    ...
    while (conversionType.lower() == "b" and len(number2Convert) != 8 or int(number2Convert) > 11111111):
        number2Convert = input("Please type a valid value!!! : ")

    while (conversionType.lower() == "d" and int(number2Convert) < 0 or int(number2Convert) > 255):
        number2Convert = input("Please type a valid value!!! : ")
